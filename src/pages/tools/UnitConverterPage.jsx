...
function UnitConverterPage() {
  usePageTitle(
    'Unit Converter | FastToolKits',
    'Free unit converter: convert length, weight, temperature, area, volume, and time between common units instantly in your browser.',
    { structuredData }
  )
    ...
    <ToolLayout tool={tool}>
      ...
      <ToolInfo title="How this works">
        <p>
          ...
          value. Each category uses accurate conversion factors, so results stay reliable across
